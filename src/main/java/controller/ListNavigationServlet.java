...
public class ListNavigationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(act == null) {
			...
			ListClubHelper daoForClubs = new ListClubHelper();
			request.setAttribute("allClubs", daoForClubs.showAllClubs());
			if(daoForClubs.showAllClubs().isEmpty()) {
				request.setAttribute("allClubs", " ");
			}
			...
			getServletContext().getRequestDispatcher("/addClubsForListServlet").forward(request, response);
		}
	}
